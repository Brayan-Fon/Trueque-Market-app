...
<body>
    ...
    <footer style="background-color: #2c3e50; color: white; padding: 20px 0;">
        <div style="display: flex; justify-content: center; gap: 50px; flex-wrap: wrap; align-items: center;">
            <div>
                <p><strong>📧 Correo:</strong> <a href="mailto:trueque_market@gmail.com"
                        style="color: white; text-decoration: none;">trueque_market@gmail.com</a></p>
            </div>
            <div>
                <p><strong>📞 Teléfono:</strong> <a href="tel:+573123452983"
                        style="color: white; text-decoration: none;">+57 312 345 2983</a></p>
            </div>
            <div>
