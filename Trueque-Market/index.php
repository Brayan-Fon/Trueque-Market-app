...
<body>
    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class="bi bi-chat"></i>Bienvido a Trueque Market</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 text-content">
                    <h1>PLATAFORMA DIGITAL PARA REALIZAR TUS TRUEQUES</h1>
                    <p>Intercambia lo que tienes, consigue lo que necesitas.
                    </p>

                </div>
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <img src="IMG/fondo.png" alt="" class="img-fluid">
                </div>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Address</h3>
                                <p>Route de sion 37,<br>Sierre, Switzerland</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
 ...
 <!---
  ...
  <div style="display: flex; justify-content: center; gap: 50px; flex-wrap: wrap; align-items: center;">
    <div>
      <p><strong>📧 Correo:</strong> <a href="mailto:trueque_market@gmail.com" style="color: white; text-decoration: none;">trueque_market@gmail.com</a></p>
    </div>
    <div>
      <p><strong>📞 Teléfono:</strong> <a href="tel:+573123452983" style="color: white; text-decoration: none;">+57 312 345 2983</a></p>
    </div>
    <div>
      <p><strong>📍 Dirección:</strong> Carrera 8h #172 - 20</p>
    </div>
  </div>
  <div style="text-align: center; margin-top: 15px;">
    <p style="margin: 0;">&copy; 2025 Trueque Market. Todos los derechos reservados.</p>
  </div>
</footer>
